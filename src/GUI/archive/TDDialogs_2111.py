...
class TD_configurationDialog(AbstractDialog):
    ...
    def retranslateUi(self, configDialog):
        ...
        self.overlapThreshold.setToolTip(_translate("configDialog", "ions which have a lower proportion in overlap pattern are deleted"))
        self.label_39.setText(_translate("configDialog", "max. nr. of overlapping ions"))
        self.manualDeletion.setToolTip(_translate("configDialog", "if overlap-pattern contains more ions, user is asked to manually delete ions"))
