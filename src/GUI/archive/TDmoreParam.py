...
class Ui_configDialog(object):
    ...
    def retranslateUi(self, configDialog):
        ...
        self.overlapThreshold.setStatusTip(_translate("configDialog", "ions which have a lower proportion in overlap pattern are deleted"))
        self.label_39.setText(_translate("configDialog", "max. nr. of overlapping ions"))
        self.manualDeletion.setStatusTip(_translate("configDialog", "if overlap-pattern contains more ions, user is asked to manually delete ions"))
